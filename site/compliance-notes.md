...
|---|---|
| Pages audited | **25** |
| axe-core violations (wcag2a, wcag2aa, **wcag2aaa**, wcag21a, wcag21aa, wcag22aa, best-practice) | **0** across 1055 individual checks passed |
| Text and background pairs measured on the rendered page | 666 |
| Pairs meeting Level AA (4.5:1 normal, 3:1 large) | **666 of 666** |
| Pairs meeting Level **AAA** (7:1 normal, 4.5:1 large) | **666 of 666** |
| Lowest contrast ratio anywhere on the site | **7.32:1** |
| Interactive targets measured | 1034 |
| Meeting 2.5.8 Target Size (Minimum), 24px, Level AA | **1034 of 1034** |
| Meeting 2.5.5 Target Size (Enhanced), 44px, Level **AAA** | **1034 of 1034** |
...
| `label-kit.html` | Figure labelling tool | Instructor only | 0 | 8.96:1 | 2 |
...
ratio seen for that pair at any size on any page. 39 pairs.
...
As of August 30, 2026, all 25 audited files meet WCAG 2.2 Level AA, and meet
...
7.32:1 and 2.5.5 Target Size (Enhanced) at 44px on all 1034
interactive targets. 0 violations were found across 1055
