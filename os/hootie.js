    ...
    switch (id) {
      ...
      case 'grades':
        return '<p>Four categories:</p>'
          ...
          + '<br><br>Your Competency Study Guide, the practice items, the Mastery Check and the recall cards carry <b>no points at all</b>, on purpose. They are the route to the four above, not extras. Full detail in your ' + ilink(s.syllabus, 'syllabus') + '.';
