...
- Week 1 Discussion 1B asks about the Mastery Check, which sits one step later in the
  Check stage. The Step 8 page tells students to do Step 9 first and come back. That is a
  wording fix, not a structural one; if it confuses anyone, the fallback is to move 1B to
  its own page after Step 9.
