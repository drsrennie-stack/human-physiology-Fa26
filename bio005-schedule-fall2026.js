/* ============================================================
   ...
   3. READING BEFORE VIDEO, ALWAYS. The note sheet gets a first pass from
      the written notes and the textbook before any lecture is watched,
      then a second pass in a different color from the video. A student
      who watches first recognizes the material instead of producing it,
      and the sheet stops showing the gap that makes the week work.
   4. Nothing requires the instructor to be present at a moment.
   5. Checkpoints replace attendance. Each week has one low-stakes
      graded checkpoint that closes on time.
   6. Exams are windows. An exam that opens Friday and closes Monday
...
window.BIO005_WEEK_SHAPE = [
  ...
  { beat:'Step 2. Teach', stage:'1 Learn', when:'Monday to Wednesday', minutes:196,
    what:'Two passes on the note sheet. First pass from the written notes and the book, before any video. Then the concept video with the slide page open beside it, and a second pass adding what the video gives you in a different color. Stop at every concept check and answer it before opening the answer.',
    graded:'ungraded' },
