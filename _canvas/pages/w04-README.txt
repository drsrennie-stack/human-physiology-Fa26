Week 4 Canvas module, top to bottom. Title each module item exactly as below, and paste the file into its body or description in the HTML editor.

Week 4 | Start here: Membrane potential, neurons and synapses   ->  w04-00-start-here.html  (built by build_canvas_week_start.py)
Week 4, Step 1 | Pre-read, before anything else   ->  w04-01-pre-read-before-anything-else-ASSIGNMENT.html  (Canvas ASSIGNMENT: paste into its description)
Week 4, Step 2 | First pass, in your first color   ->  w04-02-first-pass-in-your-first-color.html  (Canvas PAGE)
