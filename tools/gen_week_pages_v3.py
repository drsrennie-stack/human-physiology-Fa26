...
/* no accent bar on cards: white cards lifted by shadow only (her rule) */
...
<main id="main"><div class="wrap">
  ...
  <section class="shelf learn free" id="learn" aria-labelledby="learn-h">
    ...
    <p class="sub">After the lectures</p>
    <ul class="tools small" aria-label="After the lectures">{learn_sub}</ul>
  </section>
...
<div class="wrap">
  <header class="site-header">
    <a class="logo" href="index.html" target="_top" aria-label="BIO 005 Human Physiology, course home">
      <svg viewBox="40 10 125 148" role="img" aria-hidden="true"><g transform="translate(22.03,6.53) scale(4.73)"><circle cx="8" cy="8" r="4.2" fill="#0B1530"/><circle cx="17" cy="8" r="4.2" fill="#8B3A2E"/><circle cx="26" cy="8" r="4.2" fill="#C9A14A"/><rect x="5.5" y="15" width="5" height="14" rx="2.5" fill="#0B1530"/><rect x="14.5" y="15" width="5" height="14" rx="2.5" fill="#8B3A2E"/><rect x="23.5" y="15" width="5" height="14" rx="2.5" fill="#C9A14A"/></g></svg>
